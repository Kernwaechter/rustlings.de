...
// TODO: Füge den richtigen Rückgabetyp `Result<(), Box<dyn ???>>` hinzu. Was
// können wir benutzen, um beide Fehler zu beschreiben? Gibt es einen Trait,
// den beide Fehler implementieren?
fn main() {
