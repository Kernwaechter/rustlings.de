...
fn compose_me(input: &str) -> String {
    // Das Makro `format!` hat dieselbe Syntax wie `println!`, gibt aber einen
    // String zurück, statt ihn im Terminal auszugeben.
    // Äquivalent zu `input.to_string() + " Welt!"`
    format!("{input} Welt!")
}

fn replace_me(input: &str) -> String {
    input.replace("Autos", "Luftballons")
}
